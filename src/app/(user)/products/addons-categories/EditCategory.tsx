  ...
  async function onSubmit(values: AddCategoryValue) {
    startTransition(async () => {
      try {
        ...
        toast({
          title: "Addon Category Added",
          description: "Addo category has been successfully added.",
        });
        form.reset();
        setIsOpen(false);
      } catch {
        toast({
          title: "Error",
          description: "Failed to add addon category.",
          variant: "destructive",
        });
      }
    });
  ...
  return (
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      ...
      <SheetContent className="sm:max-w-[588px] h-full">
        <SheetHeader>
          <SheetTitle>Edit Addon Category</SheetTitle>
